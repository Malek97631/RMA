...
for x in range(1000):
	...
	B = f'Mozilla/5.0(Linux;Android10;SM-A105M)AppleWebKit/537.36(KHTML,likeGecko)Chrome/107.0.5214.142MobileSafari/537.3'
	...
	D = f'Mozilla/5.0 (SAMSUNG; SAMSUNG-GT-S'
	F = f'Mozilla/5.0 (Linux; U; Android 5.0.2; zh-CN; Redmi Note 3 Build/LRX22G) AppleWebKit/537.36 (KHTML, like Gecko) Version/4.0 OPR/11.2.3.102637'
	G = f'Mozilla/5.0 (Mobile; Windows Phone 8.1; Android 4.0; ARM; Trident/7.0; Touch; rv:11.0; IEMobile/11.0; Microsoft; Lumia 430 Dual SIM) like iPhone OS 7_0_3 Mac OS X AppleWebKit/537 (KHTML, like Gecko) Mobile Safari/537'	
	uaku = f'{A}{B}{C}{D}{F}{G}'
	ugen.append(uaku)
for x in range(10):
